...
<html>
<head>
    <title>Accepted Darshan Bookings</title>
</head>
<body>
    <h2>✅ Accepted Darshan Bookings</h2>
    <table border="1" cellpadding="10" cellspacing="0">
        ...
        <tbody>
            <?php
            $result = mysqli_query($conn, "SELECT * FROM bookings WHERE status='Accepted' ORDER BY id DESC");
